...
Me.DICE_LIBRARY = {
	...
	{ id = "die_radomir",     name = "Radomir's die",         weights = { 38.5,  7.7,  7.7,  7.7, 15.4, 23.0 }, desc = "A playing die made specially for Radomir." },
	{ id = "die_ambroz",     name = "Ambrose's dice",        weights = { 28.6, 21.4,  7.1,  7.1, 14.3, 21.4 }, desc = "Dice that belonged to Ambrose, the Emberhollow tailor, and now maybe to me?" },
	...
	{ id = "die_d",          name = "Jae die",                weights = { 13.0, 13.0, 13.0, 13.0, 13.0, 34.8 }, desc = "The second in the line of demonic playing dice." },
	...
	{ id = "die_e",          name = "Den die",               weights = { 13.0, 13.0, 13.0, 13.0, 13.0, 34.8 }, desc = "The third and last in line of demonic dice." },
	{ id = "die_kcd",        name = "Arathi Empire die",     weights = { 36.8, 10.5, 10.5, 10.5, 10.5, 21.0 }, desc = "A miraculous playing die, sent from the Arathi Empire to the Eastern Kingdoms." },
	{ id = "die_l",          name = "Nemma's beta die",      weights = { 11.1, 44.4, 11.1, 11.1, 11.1, 11.1 }, desc = "A playing die that Nemma secretly made to bring her luck in love, which is why she'd rather not use it to gamble with." },
	...
	{ id = "die_c",          name = "Kil die",                weights = { 13.0, 13.0, 13.0, 13.0, 13.0, 34.8 }, desc = "The first of the line of demonic dice." },
	...
	{ id = "die_vera",      name = "Veronica's lucky dice",  weights = { 27.3,  4.6,  9.1, 13.6, 18.2, 27.3 }, desc = "Playing dice that brings Veronica luck. I heard she carved it herself. From bigger dice." },
