...
local function MainCommand( msg )
	...
	elseif command == "resetbutton" or command == "resettyping" then
		Me.Typing_ResetButton()
	...
	elseif command == "atk" or command == "def" then
		...
		Me.PrintSystemMessage( "- /eph resetbutton  -- move the typing button back to its default spot under the chat tab (also: resettyping)" )
